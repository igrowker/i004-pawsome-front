    ...
    <div className="max-w-4xl mx-auto bg-white p-6 sm:p-8">
      <div className="flex flex-col sm:flex-row items-center sm:items-start mb-8">
        ...
        <div className="flex flex-col sm:ml-6 sm:flex-grow text-center sm:text-left">
          ...
          <p className="text-[#b4a293] text-sm">alexandra.j@example.com</p>
        </div>
      ...
      <div className="flex justify-center border-b mb-6">
        {['profile', 'donations', 'requests'].map((tab) => (
          <button
            ...
            className={`pb-2 px-4 text-lg ${activeTab === tab ? 'text-[#b4a293] border-b-2 border-[#b4a293] font-semibold' : 'text-gray-500'}`}
          >
            {tab === 'profile' && 'Perfil'}
